...
public interface AccountRepository extends CrudRepository<Account, Integer> {
    ...
    @Modifying
    @Query(value = "INSERT INTO accounts(user_id, account_number, account_name, account_type,create_at,updated_at) VALUES" +
            "(:user_id, :account_number, :account_name, :account_type,:create_at,:updated_at)",nativeQuery = true)
